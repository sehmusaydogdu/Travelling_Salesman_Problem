...
class DisplayMessage{       //tam çalışmıyor bakılması gerek.

    static void show(final Context context, String title, String text, final Intent intent){           //Oyun bitince level menuye dönmeye yarayacak methot
